...
class BloxorzSuite extends FunSuite {
  ...
  test("legal neighbors") {
    new Level1 {
      assert(
        Block(Pos(2, 4), Pos(3, 4)).legalNeighbors.toSet == Set((Block(Pos(1, 4), Pos(1, 4)), Up),
          (Block(Pos(2, 3), Pos(3, 3)), Left), (Block(Pos(2, 5), Pos(3, 5)), Right))
      )
    }
  }
  ...
  //    new Level1 {
  //      assert(pathsFromStart == Block(goal, goal))
  //    }
  //  }
