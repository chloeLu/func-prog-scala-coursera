...
class ParallelCountChangeSuite extends FunSuite {
  ...
  test("parCountChange with money threshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
  ...
  test("parCountChange with num coins threshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
  ...
  test("parCountChange with combined threshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
